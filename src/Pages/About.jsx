...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Data Entry, Administrasi, dan Web Development
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Website dan sistem sesuai kebutuhan",
    ...
    },
    {
      ...
      label: "Certificates",
      description: "Pelatihan dan kemampuan yang dikembangkan",
      animation: "fade-up",
    },
    {
      icon: Globe,
      ...
      description: "Data entry, administrasi, dan web development",
      animation: "fade-left",
    },
    ...
    >
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Teliti dalam mengelola data, siap belajar, dan mampu beradaptasi dengan kebutuhan kerja baru."
        </blockquote>
      </div>

            <div className="grid gap-4 sm:grid-cols-2 text-left" data-aos="fade-up" data-aos-duration="1800">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-2 text-sm text-gray-200">Freelance Web Developer / Administrasi</p>
                <p className="text-sm text-gray-400">Administrasi data, dokumen, database, dan pengembangan website</p>
              </div>
            </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1PL1U5iQYsCcmVdvRp3fXc2sZ0t30Bc2F/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
