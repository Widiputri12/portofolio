...
import { Share2, User, Mail, MessageSquare, Send, Instagram, Github, MessageCircle } from "lucide-react";
...
const contactLinks = [
  { label: "Instagram", handle: "@widiputry_", url: "https://www.instagram.com/widiputry_/", icon: Instagram },
  { label: "WhatsApp", handle: "+62 855-3694-9348", url: "https://wa.me/6285536949348", icon: MessageCircle },
  { label: "GitHub", handle: "@Widiputri12", url: "https://github.com/Widiputri12", icon: Github },
];
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/widiaudy1204@gmail.com';
