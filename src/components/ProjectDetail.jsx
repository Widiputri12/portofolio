...
const ProjectDetails = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Widi Putri Audy</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Widi Putri Audy — Data Entry dan Website Creator.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Widi Putri Audy`}
        />
        <meta
